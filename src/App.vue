<template>
    <main>
        <header id="app" class="navbar navbar-expand-lg navbar-light bg-light fixed-top"
        ...
        <footer class="bg-dark mt-5">
            <div class="container footer-copyright text-center py-3">© 2020 Copyright: Adam Uklański s12708
            </div>
        </footer>
    </main>
</template>
